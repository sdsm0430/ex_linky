...
class Musical(models.Model):
    ...
    producer_logo = models.ImageField(upload_to='photo/producer_logo/%Y/%m/%d', blank=True, null=True)  #제작사 로고
    ...
    poster = models.ImageField(upload_to='photo/poster/%Y/%m/%d', blank=True, null=True)                #포스터
    banner_image = models.ImageField(upload_to='photo/banner/%Y/%m/%d', blank=True, null=True)          #배너이미지
    background_image = models.ImageField(upload_to='photo/background/%Y/%m/%d', blank=True, null=True)  #배경이미지
    repre_image = models.ImageField(upload_to='photo/representative/%Y/%m/%d', blank=True, null=True)   #대표이미지
