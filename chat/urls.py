...
urlpatterns = [
    ...
    url(r'^user_japanese/(?P<room_name>[^/]+)/$', views.user_japanese, name='user_japanese'),
    url(r'^user_english/(?P<room_name>[^/]+)/$', views.user_english, name='user_english'),
    url(r'^user_chinese/(?P<room_name>[^/]+)/$', views.user_chinese, name='user_chinese'),
